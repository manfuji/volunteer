...
const videos = [
  {
    title: ' aspernatur sint est error consectetur',
    description:
  ...
  },
  {
    title: ' aspernatur sint est error consectetur',
    description:
      ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores aspernatur.',
    image: strokesImage,
    ...
    >
      <Container>
        ...
        <p className="mt-8 font-display text-4xl font-bold tracking-tight text-slate-900">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
          aspernatur sint est error consectetur
        </p>
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
          aspernatur sint est error consectetur ex hic voluptas ipsa quisquam
          incidunt quia amet nostrum provident ea tenetur, earum molestiae!
          Modi, quaerat.
        </p>
      </Container>
