...
const tableOfContents = {
  'Getting started': {
    'Getting started': 1,
    'Intro to our team': 15,
    'Picking timeline': 20,
  },
  Fundamentals: {
    'something op': 21,
    'something ': 22,
    'something something': 26,
    'something on a something': 31,
    'Vectsomethingor shapsomethinges': 45,
  },
  'something somefsthing': {
    'something something': 50,
    'somethfsing somfsething': 57,
    'somethfsing sofsmething': 66,
    fssfsfs: 78,
  },
  'fs for fs': {
    'rw for rw': 82,
