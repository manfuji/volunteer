        ...
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">Arli Zeba –</span> Hey
              there, I’m Lorem ipsum dolor sit amet consectetur adipisicing
              elit.
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptatum natus accusantium molestiae optio neque. Eaque modi
              quisquam veritatis excepturi praesentium, ad dignissimos
              cupiditate, molestias nesciunt sint ipsum enim consectetur placeat
              quo. Voluptatem culpa saepe quidem perspiciatis delectus enim,
              maxime tenetur soluta pariatur a debitis, eos ipsa officia iusto
              esse quod?
            </p>
            <p className="mt-8">
              <Link
