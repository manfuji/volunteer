    ...
    >
      <Container>
        ...
        <p className="mt-4 max-w-xl text-lg tracking-tight text-slate-600">
          ...
          magni quod nisi deserunt? Molestias pariatur similique unde fugit
          tempore distinctio dignissimos iste cumque omnis, assumenda ipsam
          doloremque quae expedita ducimus!
        </p>
      </Container>
